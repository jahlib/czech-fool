...
- 4 масти: ♥️ Черви, ♦️ Бубны, ♣️ Трефы, ♠️ Пики
...
### Ходы
- Карты кладутся по принципу UNO: масть на масть или номинал на номинал
- **Взятие карт:**
...
#### По сети (с друзьями):
1. **Хост (тот кто запустил сервер):**
...
- **Backend**: Python, websockets, aiohttp, SQLite
- **Frontend**: Vanilla JavaScript, HTML5, CSS3
- **Протокол**: WebSocket для real-time коммуникации
- **База данных**: SQLite для сохранения состояния игры
...
- ✅ **Сохранение состояния игры в SQLite**
...
- **Слева**: Противник (3+ игрока) - карты повёрнуты на 90°
- **Справа**: Противник (4 игрока) - карты повёрнуты на 90°
- **Подсветка**: Текущий игрок подсвечивается синим с анимацией
...
5. Все состояние игры хранится в SQLite базе данных
